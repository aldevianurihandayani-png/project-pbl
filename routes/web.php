...
Route::prefix('koordinator')
    ...
    ->group(function () {
        ...
        // ================= PROFILE =================
        Route::get('profile', [KoordinatorProfileController::class, 'show'])
            ->name('profile');

        Route::get('profile/edit', [KoordinatorProfileController::class, 'edit'])
            ->name('profile.edit');

        Route::put('profile', [KoordinatorProfileController::class, 'update'])
            ->name('profile.update');
