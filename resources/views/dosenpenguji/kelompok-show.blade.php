{{-- resources/views/dosenpenguji/kelompok-show.blade.php --}}
@extends('dosenpenguji.layout')

@section('title', 'Detail Kelompok')
@section('header', 'Detail Kelompok')
    ...
    <section class="card">
        ...
        <div class="card-hd">
            <div>
                ...
                Detail Kelompok: <strong>{{ $kelompok->nama ?? '-' }}</strong>
            </div>

            {{-- Dosen penguji HANYA MELIHAT, tidak ada tombol edit/hapus --}}
        </div>
        ...
        <div class="card-bd" style="font-size:15px;">
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:20px; margin-bottom:25px;">
                ...
                <div>
                    ...
                    <p><strong>Dosen Pembimbing:</strong> {{ $kelompok->dosen_pembimbing ?? '-' }}</p>
                    <p><strong>Dosen Penguji:</strong>
