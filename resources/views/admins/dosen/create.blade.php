...
<div class="container-fluid">
    ...
    <style>
        ...
        /* layout form: 2 kolom di desktop, 1 kolom di mobile */
        .dsn-grid{
            display:grid;
    ...
    <div class="dsn-shell">
        ...
        <div class="dsn-pagehead">
            <div>
                <h1 class="dsn-title">Tambah Dosen</h1>
                <div class="dsn-sub">Lengkapi data dosen di bawah ini, lalu klik simpan.</div>
            </div>
        </div>
