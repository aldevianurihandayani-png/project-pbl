...
<head>
  ...
  <title>@yield('title', 'Jaminan Mutu')</title>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    header.topbar{ background:#0a1a54; color:#fff; padding:12px 22px; display:flex; align-items:center; justify-content:space-between;
      position:sticky; top:0; z-index:3; box-shadow:var(--shadow); overflow:visible; }
    ...
    .notif-btn{ background:transparent; border:0; padding:0; color:inherit; cursor:pointer; display:inline-block; line-height:1; }
    ...
    .notif-dropdown{ position:absolute; top:34px; right:0; width:320px; background:#fff; border:1px solid #e5e7eb; border-radius:14px;
      box-shadow:0 12px 30px rgba(0,0,0,.18); overflow:hidden; display:none; z-index:9999; }
    .notif-dropdown.show{ display:block; }
    .notif-dd-head{ background:var(--navy); color:#fff; padding:12px 14px; display:flex; justify-content:space-between; align-items:center; font-weight:700; }
    .notif-dd-item{ display:block; padding:12px 14px; text-decoration:none; color:#111827; border-bottom:1px solid #eef2f7; }
...
<body>
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <div class="menu">
      ...
      <a href="{{ route('jaminanmutu.dashboard') }}" class="{{ request()->is('jaminanmutu/dashboard') ? 'active' : '' }}">
        <i class="fa-solid fa-house"></i>Dashboard
      </a>

      <a href="{{ url('/jaminanmutu/penilaian') }}" class="{{ request()->is('jaminanmutu/penilaian*') ? 'active' : '' }}">
        <i class="fa-solid fa-users"></i>Penilaian
      </a>

      <a href="{{ route('jaminanmutu.rubrik.index') }}" class="{{ request()->is('jaminanmutu/rubrik*') ? 'active' : '' }}">
  ...
  <main>
    <header class="topbar">
      ...
      <div class="welcome">
        <h1 style="margin:0;font-size:18px;">@yield('page_title','Jaminan Mutu (PBL)')</h1>
      </div>

      <div class="userbox" style="display:flex;align-items:center;gap:14px;overflow:visible;">
        <div class="notif" id="notifWrapJM">
          ...
          <div class="notif-dropdown" id="notifBoxJM">
            ...
            @empty
              <div class="notif-dd-item" style="border-bottom:0;color:#6b7280;">Tidak ada notifikasi</div>
            @endforelse
