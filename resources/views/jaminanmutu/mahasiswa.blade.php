...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .btn-add{
      background:var(--blue); color:#fff; padding:8px 18px; border-radius:20px; border:none; font-weight:700; cursor:pointer;
    }
    .btn-add:hover{ background:#0045c5 }
...
<body>
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <div class="menu">
      ...
      <a href="{{ url('/dosen/mahasiswa') }}" class="active"><i class="fa-solid fa-user-graduate"></i>Mahasiswa</a>
  ...
  <main>
    ...
    <div class="page">
      ...
      <div class="toolbar">
        ...
        <a href="#" class="btn-add">TAMBAH MAHASISWA</a>
        {{-- ganti href ke route create saat CRUD sudah dibuat, mis: route('dosen.mahasiswa.create') --}}
      </div>
        ...
        <table id="tabelMahasiswa">
          ...
          <tbody>
            <tr data-kelas="A">
              ...
              <td>
                <div class="actions">
                  <a href="#" class="pill view">VIEW</a>
                  <a href="#" class="pill edit">EDIT</a>
                  <a href="#" class="pill delete">DELETE</a>
                </div>
              </td>
            </tr>
            <tr data-kelas="B">
