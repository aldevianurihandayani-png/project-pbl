...
<div class="container-fluid">
    ...
    <style>
        ...
        /* ============ GRID KELAS (OVERVIEW) ============ */
        /* ubah jadi flex supaya ukuran kartu bisa fixed dan tidak terlalu lebar */
        .kelas-grid {
            display: flex;
            flex-wrap: wrap;
            gap: 18px;
        ...
        .kelas-card {
            position: relative;
            width: 320px;                 /* <<< ukuran kartu diperkecil */
            max-width: 100%;
            border-radius: 16px;
            background: #ffffff;
            padding: 14px 16px 12px;       /* <<< padding diperkecil */
            display: flex;
        ...
        /* CARD MAHASISWA DI HALAMAN DETAIL (tetap sama) */
        .mhs-grid {
            display: flex;
            flex-direction: column;
            gap: 14px;
            ...
            <div class="d-flex justify-content-between align-items-end mb-3 mt-1">
                <div>
                    ...
                    <p class="mhs-subtitle mb-0">
                        Menampilkan semua mahasiswa yang terdaftar di kelas {{ $kelasFilter }}.
                    </p>
                </div>
