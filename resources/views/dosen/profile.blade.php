{{-- resources/views/dosen/profile.blade.php --}}
@extends('layouts.dosen')

@section('title', 'Profil — Dosen Pembimbing')
@section('header', 'Profil Dosen Pembimbing')
  ...
  <div class="dp-grid">
    ...
    <div class="dp-card">
      <div class="dp-card-h">
        ...
        {{-- LINK EDIT PROFIL --}}
        <a href="{{ url('dosen/profile/edit') }}" class="dp-btn">
